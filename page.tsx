...
{/*type writer effect*/}
 ...
 <Typewriter 
   options={{
     strings: ['Expert in above Languages'],
     autoStart: true,
     loop: true,
   }}
 />
...
<div>
        <Image  className="flex flex-end pr-4 rounded-full pt-42 mr-96 transition-transform duration-300 ease-in-out transform  hover:scale-110" src={"/images/farhat.jpg"} alt="logo" width={400} height={400} ></Image>
